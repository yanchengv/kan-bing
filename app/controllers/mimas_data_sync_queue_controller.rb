    ...
    if table_name == 'PacsFileRef'
      ...
      if @datas
        if table_name == 'Appointment'
          app_data = {id:@datas.id.to_s,patient_id:@datas.patient_id,doctor_id:@datas.doctor_id,appointment_day:@datas.appointment_day,start_time:@datas.start_time.to_time.strftime("%H:%M"),end_time:@datas.end_time.to_time.strftime("%H:%M"),status:@datas.status,hospital_id:@datas.hospital_id,department_id:@datas.department_id,appointment_schedule_id:@datas.appointment_schedule_id,dictionary_id:@datas.dictionary_id,appointment_arrange_id:@datas.appointment_arrange_id,doctor_name:@datas.doctor_name,patient_name:@datas.patient_name,hospital_name:@datas.hospital_name,department_name:@datas.department_name,dictionary_name:@datas.dictionary_name}
        elsif table_name == 'AppointmentSchedule'
          app_data = {id:@datas.id.to_s,doctor_id:@datas.doctor_id,schedule_date:@datas.schedule_date,start_time:@datas.start_time.to_time.strftime("%H:%M"),end_time:@datas.end_time.to_time.strftime("%H:%M"),avalailbecount:@datas.avalailbecount,status:@datas.status,remaining_num:@datas.remaining_num}
