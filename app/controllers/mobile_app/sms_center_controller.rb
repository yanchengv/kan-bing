class MobileApp::SmsCenterController < ApplicationController
  ...
  def sent
    ...
    if @user.nil?
      ...
      input_encode='gbk'
      out_encode='utf8'
      msg=Iconv.new('gb2312','utf8').iconv("恭喜您，注册的健康管理平台审核通过。您的激活验证码为："+verify_code+"请及时登陆www.kanbing365.com网站激活，以防被盗。")
      url=URI.escape('http://www.smsadmin.cn/smsmarketing/wwwroot/api/get_send/?uid=yc1022&pwd=yc1022&mobile='+mobile_phone+'&msg=xiaolizininhao'+msg)
