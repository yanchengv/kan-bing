class MobileApp::SmsCenterController < ApplicationController
  ...
  def sent
    ...
    # else
      ...
      input_encode='gbk'
      out_encode='utf8'
      msg=Iconv.new('gb2312','utf8').iconv("恭喜您，注册的健康管理平台审核通过.您的激活验证码为："+verify_code+"。请及时登陆:www.kanbing365.com网站激活，以防丢失.[北京华康同邦科技有限公司]")
      url=URI.escape('http://www.smsadmin.cn/smsmarketing/wwwroot/api/get_send/?uid=viicare&pwd=viicare123&mobile='+mobile_phone+'&msg=xiaolizininhao'+msg)
