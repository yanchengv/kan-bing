class NoteTagsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @note_tag.save
        format.html { redirect_to @note_tag, notice: 'NoteTag was successfully created.' }
        format.json { render :show, status: :created, location: @note_tag }
      else
  ...
  def update
    respond_to do |format|
      if @note_tag.update(note_tag_params)
        format.html { redirect_to @note_tag, notice: 'NoteTag was successfully updated.' }
        format.json { render :show, status: :ok, location: @note_tag }
      else
