...
class InspectionUltrasound < ActiveRecord::Base
  ...
  attr_accessible :id, :patient_id, :patient_name, :patient_code, :parent_type, :child_type, :thumbnail, :identifier,
                  ...
                  :inputer_name,:report_image_list,:us_finding,:us_diagnose,:statics,:station_fee,:report_print_fee,:item_fee,
                  :desc_fee,:_id,:clinic_no,:hospitalized_no,:_id, :data_source_number
