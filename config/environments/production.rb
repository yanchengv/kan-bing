Mimas::Application.configure do
  ...
  config.assets.precompile += ['jquery.mobile-1.3.2.min.js','jquery.mobile-1.3.2.min.css','weixin.js','paginate.js','ajax_image_crop_upload.js','fullcalendar.js','health_records.js',
                               ...
                               'fancybox.css','fullcalendar.css','timeline.css','timeline_data.css','exporting.js',
                                ...
                                'highcharts/body_age.js','highcharts/smrwb.js','highcharts/vfl.js','notes.js','js/ajaxfileupload.js','patients/diagnose_treat.js','patients/diagnose_treat_form.js']
  ...
  #config.logger = Logger.new(config.paths["log"].first, 'weekly') # 日志分割 daily或 weekly,monthly
